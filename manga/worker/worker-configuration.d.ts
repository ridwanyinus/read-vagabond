/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: afb509cc956fa14cb6882be80617e19c)
...
declare namespace Cloudflare {
	...
	interface Env {
		vagabond_manga_vizbig: R2Bucket;
	}
}
...
type ImageOutputOptions = {
	format: 'image/jpeg' | 'image/png' | 'image/x-icon' | 'image/webp' | 'image/avif' | 'rgb' | 'rgba';
	quality?: number;
	background?: string;
	anim?: boolean;
};
